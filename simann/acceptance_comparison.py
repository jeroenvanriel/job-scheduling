...
accept_exp1 = instance.start(100000, exponentialDecay, 9.8e9, 4e10) #tried to use max(jobs_file) for the third entry to get the largest single processing time as good_accept, but that does not work. 
accept_exp1.plotResults("{}1.png".format(output_prefix))

accept_exp2 = instance.start(100000, exponentialDecayNonInc, 8e10, 4e10)
